...
namespace Gem {
	...
	class HumanInterfaceDeviceContext : public Apatite::ISubSystem {  //TODO better name, glfw does not need to be included
	public:
		...
		[[nodiscard]] WindowHandle CreateWindowHandle(const Malachite::Vector2i& size = Malachite::Vector2i{ 100, 100 }, const std::string& title = "Gemstone") const;
