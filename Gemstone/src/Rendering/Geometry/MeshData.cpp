...
namespace Gem {
	Vertex::Vertex(const Vector3f& positionData, const Vector3f& normalData, const Vector2f& textureCoordinateData)
	...
	MeshData::MeshData(const Ptr<Shape>& shape)
