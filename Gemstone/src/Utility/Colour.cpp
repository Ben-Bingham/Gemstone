...
namespace Gem {
	...
	Colour::Colour(const Vector4f colour)
		: colour(colour) {}
	Colour::Colour(Vector3f colour, float alpha)
	...
	Vector3f Colour::toVec3() const { return Vector3f{colour.x, colour.y, colour.z}; }
	Vector4uc Colour::toVec4() const {
		return Vector4uc{
	...
	Vector4f Colour::initWith0To255(const int r, const int g, const int b, const int a) {
