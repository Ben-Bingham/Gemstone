...
namespace Gem {
	...
	//		aIntoB.x = clamp(aIntoB.x, -box1Dimensions.x / 2.0f, box1Dimensions.x / 2.0f);
	//		aIntoB.y = clamp(aIntoB.y, -box1Dimensions.y / 2.0f, box1Dimensions.y / 2.0f);
	//		aIntoB.z = clamp(aIntoB.z, -box1Dimensions.z / 2.0f, box1Dimensions.z / 2.0f);

	//		Point3D box2Dimensions = box2->getDimensions();

	//		Point3D bIntoA = box1Origin - box2Origin;
	//		bIntoA.x = clamp(bIntoA.x, -box2Dimensions.x / 2.0f, box2Dimensions.x / 2.0f);
	//		bIntoA.y = clamp(bIntoA.y, -box2Dimensions.y / 2.0f, box2Dimensions.y / 2.0f);
	//		bIntoA.z = clamp(bIntoA.z, -box2Dimensions.z / 2.0f, box2Dimensions.z / 2.0f);
	...
	//		aIntoB.x = clamp(aIntoB.x, -boxDimensions.x / 2.0f, boxDimensions.x / 2.0f);
	//		aIntoB.y = clamp(aIntoB.y, -boxDimensions.y / 2.0f, boxDimensions.y / 2.0f);
	//		aIntoB.z = Gem::clamp(aIntoB.z, -boxDimensions.z / 2.0f, boxDimensions.z / 2.0f);
